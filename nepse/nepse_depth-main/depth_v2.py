...
class TokenParser:
    ...
    def parse_token_response(self, token_response):
        ...
        parsed_access_token = (
            access_token[0:n] + access_token[n + 1 : l] + access_token[l + 1 :]
        )
        parsed_refresh_token = (
            refresh_token[0:i] + refresh_token[i + 1 : r] + refresh_token[r + 1 :]
        )
...
class Nepse:
    def __init__(self):
        ...
        self.top_ten_scrips_url = (
            "https://www.nepalstock.com.np/api/nots/top-ten/trade-qty"
        )
        self.supply_demand_url = (
            "https://www.nepalstock.com.np/api/nots/nepse-data/supplydemand"
        )
        self.turnover_url = "https://www.nepalstock.com.np/api/nots/top-ten/turnover"
        self.top_gainers_url = (
            "https://www.nepalstock.com.np/api/nots/top-ten/top-gainer"
        )
        self.top_losers_url = "https://www.nepalstock.com.np/api/nots/top-ten/top-loser"
        self.nepse_open_url = (
            "https://www.nepalstock.com.np/api/nots/nepse-data/market-open"
        )
        self.nepse_index_url = "https://www.nepalstock.com.np/api/nots/nepse-index"
        self.nepse_subindices_url = "https://www.nepalstock.com.np/api/nots"
        self.getStockDepth_url = (
            "https://www.nepalstock.com.np/api/nots/nepse-data/marketdepth/{}"
        )
        self.getListedStock_url = (
            "https://www.nepalstock.com.np/api/nots/securityDailyTradeStat/{}"
        )
        self.get_all_listed_url = "https://www.nepalstock.com.np/api/nots/company/list"
        self.get_market_depth_url = (
            "https://www.nepalstock.com.np/api/nots/nepse-data/marketdepth/{}"
        )
    ...
    def getStockDepth(self, sid):
        ...
        return self.requestAPI(
            url=self.getStockDepth_url.format(sid), access_token=access_token
        )

    def getListedStock(self, sect_id):
        access_token = self.getValidToken()
        return self.requestAPI(
            url=self.getListedStock_url.format(sect_id), access_token=access_token
        )
    ...
    def get_market_depth(self, id):
        access_token = self.getValidToken()
        return self.requestAPI(
            url=self.get_market_depth_url.format(id), access_token=access_token
        )
